...
from app.bot.handlers.admin import ACCESS_DENIED_MESSAGE, cmd_add_rule, cmd_admin, is_admin
...
async def test_cmd_add_rule_requires_args():
    ...
    message.answer.assert_awaited_once_with("Использование: /add_rule <текст правила>")
